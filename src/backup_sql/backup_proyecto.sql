...
-- Started on 2022-11-18 16:45:22
...
-- Name: Orden; Type: TABLE; Schema: public; Owner: proyecto
--
...
ALTER TABLE public."Orden" OWNER TO proyecto;

--
-- TOC entry 218 (class 1259 OID 24598)
-- Name: Orden_producto; Type: TABLE; Schema: public; Owner: proyecto
--
...
ALTER TABLE public."Orden_producto" OWNER TO proyecto;

--
-- TOC entry 221 (class 1259 OID 24613)
-- Name: PC_Armado; Type: TABLE; Schema: public; Owner: proyecto
--
...
ALTER TABLE public."PC_Armado" OWNER TO proyecto;

--
-- TOC entry 220 (class 1259 OID 24608)
-- Name: PC_Armado_Producto; Type: TABLE; Schema: public; Owner: proyecto
--
...
ALTER TABLE public."PC_Armado_Producto" OWNER TO proyecto;

--
-- TOC entry 219 (class 1259 OID 24603)
-- Name: Producto; Type: TABLE; Schema: public; Owner: proyecto
--
...
ALTER TABLE public."Producto" OWNER TO proyecto;

--
-- TOC entry 215 (class 1259 OID 24583)
-- Name: Reporte; Type: TABLE; Schema: public; Owner: proyecto
--
...
ALTER TABLE public."Reporte" OWNER TO proyecto;

--
-- TOC entry 216 (class 1259 OID 24588)
-- Name: Resena; Type: TABLE; Schema: public; Owner: proyecto
--
...
ALTER TABLE public."Resena" OWNER TO proyecto;
...
-- Name: Orden Orden_pkey; Type: CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: Orden_producto Orden_producto_pkey; Type: CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: PC_Armado_Producto PC_Armado_Producto_pkey; Type: CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: PC_Armado PC_Armado_pkey; Type: CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: Producto Producto_pkey; Type: CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: Reporte Reporte_pkey; Type: CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: Resena Resena_pkey; Type: CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: PC_Armado_Producto FK_AProducto_PCArmado; Type: FK CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: PC_Armado_Producto FK_AProducto_Producto; Type: FK CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: Orden_producto FK_OProducto_Orden; Type: FK CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: Orden_producto FK_OProducto_Producto; Type: FK CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: Orden FK_Orden_Usuario; Type: FK CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: Reporte FK_Reporte_Usuario; Type: FK CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Name: Resena FK_Resena_Usuario; Type: FK CONSTRAINT; Schema: public; Owner: proyecto
--
...
-- Completed on 2022-11-18 16:45:22
