...
const Memoria = () => {
    return <div>
        ...
        <div className='col mt-3'>
            ...
            <div class="row g-0">
                <div class="col-md-3">
                    <img src={corsairlogo} class="img-fluid rounded-start mt-3 mx-auto" alt="..."/>
                </div>
                <div class="col-md-6">
                <div class="card-body">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">CORSAIR VENGANCE 16GB RAM X1</p>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">CORSAIR VENGANCE 32GB RAM 16X2</p>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">CORSAIR VENGANCE 8GB RAM X1</p>
