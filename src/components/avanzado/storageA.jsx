...
import kingston from '../imagenes/kingston.jpg'
const Storagea = () => {
    return <div>
        ...
        <div className='col mt-3'>
            ...
            <div class="row g-0">
                <div class="col-md-3">
                    <img src={kingston} class="img-fluid rounded-start mt-3 mx-auto" alt="..."/>
                </div>
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">KINGSTON HDD 1TB</p>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">KINGSTON HDD 2TB</p>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">KINGSTON SSD 1TB</p>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">KINGSTON HDD 500GB</p>
