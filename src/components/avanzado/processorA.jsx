...
const Processora = () => {
    return <div>
        ...
        <div className='col mt-3'>
            ...
            <div class="row g-0">
                <div class="col-md-3">
                    <img src={ryzenlogo} class="img-fluid rounded-start mt-3 mx-auto" alt="..."/>
                </div>
                <div class="col-md-6">
                <div class="card-body">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">AMD RYZEN 5600</p>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">AMD RYZEN 5600X</p>
                    <p class="card-text"><small class="text-muted">550$</small></p>
                </div>
                </div>
                <div class='col-md-3 mt-4'>
                    <button className='mx-auto btn btn-primary' id='botonagregado'>+</button>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">AMD RYZEN THREADRIPPER</p>
