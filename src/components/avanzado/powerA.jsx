...
import gigabyte from '../imagenes/gigabytelogo.png'
const Powera = () => {
    return <div>
        ...
        <div className='col mt-3'>
            ...
            <div class="row g-0">
                <div class="col-md-3">
                    <img src={gigabyte} class="img-fluid rounded-start mt-3 mx-auto" alt="..."/>
                </div>
                <div class="col-md-6">
                <div class="card-body">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">GIGABYTE POWER SUPPLY 80PLUS SILVER</p>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">GIGABYTE POWER SUPPLY 80PLUS BRONZE</p>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6">
                <div class="card-body">
                    <p class="card-text">GIGABYTE POWER SUPPLY</p>
